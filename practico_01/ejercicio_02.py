...
def maximo_recursivo(*args) -> float:
    ...
    if len(args) == 1:
        ...
        return max(args[0], maximo_recursivo(*args[1:])) #esto compara el argumento de orden i de la lista con el maximo de los demas, lo que a su vez hace lo mismo con los proximos, etc...
